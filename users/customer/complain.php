...
$command="
INSERT INTO complaints(customer_id, message) 
...
?>
  ...
  if (isset($_GET['page_no']) && $_GET['page_no']!="") {
      ...
      $result_count = mysqli_query($conn,"SELECT COUNT(*) As total_records FROM complaints,customer where complaints.customer_id =customer.customer_id and complaints.customer_id ='$id'");
      ...
      $second_last = $total_no_of_pages - 1; // total page minus 1     
            ...
            $query="SELECT * from complaints,customer where complaints.customer_id =customer.customer_id and complaints.customer_id ='$id'

...
<?php include 'include/nav.php'?>
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Taken Parcel</h3>
                    </div>
                    <div class="row mb-3">
  ...
  if (isset($_GET['page_no']) && $_GET['page_no']!="") {
      ...
      $result_count = mysqli_query($conn,"SELECT COUNT(*) As total_records FROM parcel,shipper where shipper.shipper_id=parcel.shipper_id and parcel.customer_id='$id' and parcel.shipper_id >'0'");
      ...
      $second_last = $total_no_of_pages - 1; // total page minus 1     
            ...
            $query="SELECT * from parcel,shipper where shipper.shipper_id=parcel.shipper_id and parcel.customer_id='$id' and parcel.shipper_id >'0'
                                            ...
                                            <?php
                                             ...
                                             ?>
                                                <tr>
                                                    ...
                                                    <td  style="font-size: 13px;"><?php echo $rows['description'];?></td>
                                                    <td style="font-size: 13px;"><?php echo $rows['firstname'].' '.$rows['lastname'];?></td>

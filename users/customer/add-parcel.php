...
$link='https://www.google.com/maps/embed/v1/directions?key=AIzaSyCrTCu8FVMX4YQQSGFA3xhfgs8pDwA12q8&amp;origin='.$origin.'&amp;destination='.$destination.'&amp;zoom=10';
...
$command="
INSERT INTO parcel(customer_id,shipper_id ,parcel_name,parcel_image,description,origin,destination,location_link, track_key,delivered,notification_read) 
            VALUES ('$id','0','$parcelname','".$upload_file."','$description','$origin','$destination','$link','$trackkey','0','0')";
...
echo '<script>alert(" parcel added successfully");window.location = "add-parcel.php";</script>';
...
?>
                                <div class="card-body">
                                    <form action="" name="form" enctype="multipart/form-data" onsubmit="return validateForm();"  method="post">
                                        <div class="row">
                                            <div class="col">
                                                <div class="mb-3"><label class="form-label" for="username"><strong>Parcel Name</strong></label><input class="form-control" type="text" name="parcelname" id="parcelname" style="border-radius: 0px;"><span id="perror"></span></div>
                                            </div>
                                            <div class="col">
                                                <div class="mb-3"><label class="form-label" for="email"><strong>Parcel Image</strong><br></label><input class="form-control" type="file" name="photo" id="photo" accept="image/x-png,image/jpeg,image/jpg" style="border-radius: 0px;"><span id="errorpic"></span></div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col">
                                                <div class="mb-3"><label class="form-label" for="first_name"><strong>Description</strong><br></label><textarea class="form-control" name="description" id="description" style="border-radius: 0px;"></textarea><span id="errordesc"></span></div>
                                            </div>
                                        </div>
                            ...
                            <div class="card shadow">
                                ...
                                <div class="card-body">
                                    <form>
                                        <div class="row">
                                            <div class="col">
                                                <div class="mb-3"><label class="form-label" for="city"><strong>Origin</strong><br></label><input class="form-control" type="text" name="origin" id="origin" style="border-radius: 0px;" placeholder="e.g bloed street mall, pretoria"><span id="errororigin"></span></div>
                                            </div>
                                            <div class="col">
                                                <div class="mb-3"><label class="form-label" for="city"><strong>Destination</strong><br></label><input class="form-control" type="text" name="destination" id="destination" style="border-radius: 0px;" placeholder="e.g crossing mall, soshanguve"><span id="errordes"></span></div>
                                            </div>
                                        </div>
                            ...
                            <div class="card shadow" style="margin-top: 14px;">
                                ...
                                <div class="card-body">
                                    <form>
                                        <div class="row">
                                            <div class="col">
                                                <div class="mb-3"><label class="form-label" for="city"><strong>Tracker Key</strong><br></label><input class="form-control" type="url" name="key" id="key" style="border-radius: 0px;"><span id="errorkey"></span></div>
                                            </div>
                                        </div>
                                        <div class="mb-3"><button class="btn btn-sm" type="submit" style="border-radius: 0px;background: #bc0000;color: rgb(255,255,255);">add the parcel</button></div>
                                    </form>
                                </div>
                            </div>
                        </div>

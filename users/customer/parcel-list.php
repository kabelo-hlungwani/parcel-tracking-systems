  ...
  <?php include 'include/nav.php'; ?>
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">My parcels</h3>
                    </div>
                    <div class="row mb-3">
                                        ...
                                        <table class="table">
                                            ...
                                            <?php
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="3">
                                                        <p><a class="btn btn-sm" role="button" href="edit_item.php?url=<?php echo $rows['parcel_id'];?>" style="background: #bc0000;color: rgb(255,255,255);border-radius: 0px;">Edit</a>&nbsp;&nbsp;  <a class="btn btn-sm" href="del_item.php?url=<?php echo $rows['parcel_id'];?>" role="button" style="color: rgb(255,255,255);background: #bc0000;border-radius: 0px;">Delete</a></p>
                                                    </td>
                                                </tr>
                                                <?php

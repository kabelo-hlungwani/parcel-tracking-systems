...
<head>
    ...
    <title>Dashboard - History of deliveries</title>
...
<?php include 'include/nav.php'?>
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Delivery History</h3>
                    </div>
                    <div class="row mb-3">
  ...
  if (isset($_GET['page_no']) && $_GET['page_no']!="") {
      ...
      $result_count = mysqli_query($conn,"SELECT COUNT(*) As total_records FROM parcel,customer where parcel.customer_id=customer.customer_id and parcel.shipper_id='$id'and delivered='1' ");
      ...
      $second_last = $total_no_of_pages - 1; // total page minus 1     
            ...
            $query="SELECT * from parcel,customer where parcel.customer_id=customer.customer_id and parcel.shipper_id='$id'and delivered='1'
                                            ...
                                            <?php
                                             ...
                                             ?>
                                                <tr>
                                                    ...
                                                    <td  style="font-size: 13px;"><?php echo $rows['dod'];?></td>

...
$result=mysqli_query($conn,"SELECT * from shipper where email='$email'");
    ...
    <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: rgb(188,0,0);">
        <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
            ...
            <ul class="navbar-nav text-light" id="accordionSidebar">
                ...
                <li class="nav-item"><a class="nav-link" href="complain.php" ><i class="fa fa-comments" style="font-size: 16px;"></i><span>Complain</span></a>
                    <a class="nav-link" href="parcel-list.php" ><i class="fa fa-dropbox" ></i><span>View Parcels</span></a>
        ...
        <div id="content">
            <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle me-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars" style="color: rgb(188,0,0);"></i></button>
                    <h6 style="font-size: 17px;height: 25.8px;margin-top: 14px;">&nbsp;<span style="font-weight: bold;color: rgb(188,0,0);">Logged as- <a style="font-weight: bold;color: rgb(188,0,0);text-decoration: none" href="index.php"><?php echo $rows['firstname'].' '.$rows['lastname']?>(Shipper)</a><br><br></span></h6>

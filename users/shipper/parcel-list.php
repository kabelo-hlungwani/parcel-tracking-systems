...
<head>
    ...
    <title>Dashboard - Parcel List</title>
...
<?php include 'include/nav.php'?>
                                        ...
                                        <table class="table">
                                            <thead>
                                                <tr style="background: #bc0000;color: rgb(255,255,255);font-size: 14px;">
                                                    ...
                                                    <th colspan="3">Functions<i class="fa fa-cogs"></i></th>
                                                </tr>
                                            </thead>
  ...
  if (isset($_GET['page_no']) && $_GET['page_no']!="") {
      ...
      $result_count = mysqli_query($conn,"SELECT COUNT(*) As total_records FROM `parcel` where shipper_id='0'");
      ...
      $second_last = $total_no_of_pages - 1; // total page minus 1     
            ...
            $query="SELECT * from parcel where shipper_id='0'
                                            ...
                                            <?php
                                             ...
                                             ?>
                                                <tr>
                                                    ...
                                                    <td colspan="1" style="font-size: 13px;"><?php echo $rows['description'];?></td>
                                                    ...
                                                    <td colspan="3">
                                                        <p><a class="btn btn-sm" role="button" style="color: rgb(255,255,255);background: #bc0000;border-radius: 0px;" href="parcel-view.php?url=<?php echo $rows['parcel_id']?>">View</a></p>
                                                    </td>
                                                </tr>
                                                                          <?php

...
<head>
    ...
    <title>Dashboard - Shipper Complaints</title>
...
<body id="page-top" style="font-family: Poppins, sans-serif;">
                        ...
                        <div class="col-lg-12 offset-lg-0">
                            <div class="card shadow mb-3">
                                <div class="card-header py-3">
                                    <p class="m-0 fw-bold" style="color: rgb(188,0,0);">Shipper complaints List</p>
                                </div>
                                <div class="card-body">
  ...
  if (isset($_GET['page_no']) && $_GET['page_no']!="") {
      ...
      $result_count = mysqli_query($conn,"SELECT COUNT(*) As total_records FROM complaints,shipper where complaints.shipper_id >'0' and complaints.shipper_id=shipper.shipper_id");
      ...
      $second_last = $total_no_of_pages - 1; // total page minus 1     
            ...
            $query="SELECT * from complaints,shipper where complaints.shipper_id >'0' and complaints.shipper_id=shipper.shipper_id

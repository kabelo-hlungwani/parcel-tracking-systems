...
<body id="page-top" style="font-family: Poppins, sans-serif;">
  ...
  if (isset($_GET['page_no']) && $_GET['page_no']!="") {
      ...
      $result_count = mysqli_query($conn,"SELECT COUNT(*) As total_records FROM  parcel,customer  where parcel.shipper_id >'0' and customer.customer_id=parcel.customer_id ");
      ...
      $second_last = $total_no_of_pages - 1; // total page minus 1     
            ...
            $query="SELECT * from parcel,customer  where parcel.shipper_id >'0' and customer.customer_id=parcel.customer_id 

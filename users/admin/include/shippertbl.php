<tbody>
  ...
  if (isset($_GET['page_no']) && $_GET['page_no']!="") {
      ...
      $result_count = mysqli_query($conn,"SELECT COUNT(*) As total_records FROM  shipper ");
                                            ...
                                            <?php
                                             ...
                                             ?>
                                                ...
                                                <select onChange="window.location.href =this.value" class="form-control"style="border-radius: 0px;background: rgb(247,249,252);border-style: none;color: rgb(80,94,108);" name="" id="">
                                                    ...
                                                    <option value="act.php?url=<?php echo $rows['shipper_id']?>">Activate</option>
                                                    <option value="sus.php?url=<?php echo $rows['shipper_id']?>">Suspend</option>
                                                </select>

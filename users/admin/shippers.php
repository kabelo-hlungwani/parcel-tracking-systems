...
<head>
    ...
    <title>Dashboard - Shippers</title>
  ...
  <?php include 'include/nav.php';?>
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Shippers</h3>
                    </div>
                    <div class="row mb-3">
                        <div class="col-lg-12 offset-lg-0">
                            <div class="card shadow mb-3">
                                <div class="card-header py-3">
                                    <p class="m-0 fw-bold" style="color: rgb(188,0,0);">Shipper List</p>
                                </div>
                                <div class="card-body">
                                        ...
                                        <table class="table">
                                            <thead>
                                                <tr style="background: #bc0000;color: rgb(255,255,255);font-size: 14px;">
                                                    <th>#</th>
                                                    <th>Shipper Firstname</th>
                                                    <th>Shipper Lastname</th>
                                            ...
                                            <?php include 'include/shippertbl.php'; ?>
                                        </table>
                                    </div>

...
<body>
    <div style="height: 310px;background: url(&quot;../assets/img/pexels-vojtech-okenka-392018.jpg&quot;) center / cover no-repeat;">
        <div class="d-flex justify-content-center align-items-center" style="height: inherit;min-height: initial;width: 100%;position: absolute;left: 0;background: rgba(0,0,0,0.53);">
            <div class="d-flex align-items-center order-5" style="height:200px;">
                <div class="container">
                    <h3 class="text-center" style="color: var(--bs-white);padding-top: 0.25em;padding-bottom: 0.25em;font-weight: normal;"><i class="fa fa-quote-left" style="color: #bc0000;"></i>&nbsp;ERROR&nbsp;<i class="fa fa-quote-right" style="color: #bc0000;"></i></h3>
                </div>
            </div>
        </div>
    </div>
    <div class="container">
        <div class="row" style="margin-top: 21px;">
            <div class="col-md-8 col-lg-6 offset-lg-3 text-center"><i class="fas fa-exclamation-triangle" style="font-size: 40px;margin-top: 29px;"></i>
                <h4 style="color: #bc0000;margin-top: 30px;"><?php echo $err; ?></h4>
                <p style="font-size: 20px;color: var(--bs-gray);"><?php echo $message; ?></p><a href="../index.php" style="color: rgb(80,94,108);">Home page</a>
            </div>
        </div>
    </div>
